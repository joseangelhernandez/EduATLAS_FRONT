...
export default function AuthNewPasswordForm() {
  ...
  const VerifyCodeSchema = Yup.object().shape({
    code1: Yup.string().required('El código es obligatorio.'),
    code2: Yup.string().required('El código es obligatorio.'),
    code3: Yup.string().required('El código es obligatorio.'),
    code4: Yup.string().required('El código es obligatorio.'),
    code5: Yup.string().required('El código es obligatorio.'),
    code6: Yup.string().required('El código es obligatorio.'),
    email: Yup.string().required('Correo electrónico es obligatorio').email('Debe ser un correo electrónico válido'),
    password: Yup.string()
      .min(8, 'Constraseña debe ser de 8 caracteres mínimo.')
      .required('Contraseña es requerida.'),
    confirmPassword: Yup.string()
      .required('Confirmar contraseña es requrido.')
