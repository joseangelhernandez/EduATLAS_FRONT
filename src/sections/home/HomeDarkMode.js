      ...
      <Container component={MotionViewport}>
        <m.div variants={varFade().inUp}>
          <Typography component="div" variant="overline" sx={{ color: 'primary.main' }}>
            Con estilos de personalización para una mejor experiencia de usuario
          </Typography>
        </m.div>
        ...
        <m.div variants={varFade().inUp}>
          <Typography sx={{ color: 'grey.500' }}>
            Incorporamos una versión oscura para que la vista de los usuarios no se agote por el brillo de la versión predeterminada.
          </Typography>
        </m.div>
